...
\tableofcontents
\newpage
\subfile{chapters/1-Preface}
\clearpage
\subfile{chapters/2-Background}
\clearpage
\subfile{chapters/3-Context_Presentation}
\clearpage
\subfile{chapters/4-Software_Architecture}
\clearpage
\subfile{chapters/5-Implementation}
\clearpage
\subfile{chapters/6-Known_Issues_And_Limitations}
\clearpage
\subfile{chapters/7-Conclusions_And_Future_Remarks}
\clearpage
